...
WebUI.setText(findTestObject('Maintenanace/Page_Cimpl/input_English_cimpl-text-box'), 'qa_test15@cimpl.com')

WebUI.setMaskedText(findTestObject('Maintenanace/Page_Cimpl/input_English_cimpl-text-box -Password'), 'Test1234!')
